...
/proc/load_admins()
	...
	if(config.admin_legacy_system)
		...
		for(var/line in Lines)
			...
			//ensure that we loaded the admins correctly
			do_load_test(rank, rights, ckey)
...
//Used for testing admins loading in correctly. Please don't fuck with this proc, you can break things.
proc
	do_load_test(rank, rights, ckey)
		load_test_admin()
		if(check_admin(rank, rights, ckey))
			succeeded_check()

...
/var/datum/announcement/threat_announcement =new(new_sound = 'sound/AI/november/threat.ogg')
...
/datum/announcement/threat_announcement
	title = "Threat Alert"
	announcement_type = "Threat"

/datum/announcement/threat_announcement/FormMessage(message as text, message_title as text)
	. = "<h1 class='alert'>Threat Alert!</h1>"
	if (message_title)
...
/datum/announcement/decree/New(var/do_log = TRUE, var/new_sound = 'sound/misc/declaration.ogg', var/do_newscast = 0)
	..(do_log, new_sound, do_newscast)
	title = "Commandant's New Decree!"
	announcement_type = "Commandant Decree"

/datum/announcement/decree/FormMessage(message as text, message_title as text)
	. = "<h1 class='alert'>[message_title]</h1>"
	. += "<br><h2 class='alert'>[message]</h2>"
	if(announcer)
